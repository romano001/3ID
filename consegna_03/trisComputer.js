...
function trovac() {
for (let p=0;p<=8&&a[cellalibera]!=0;p++)
cellalibera=p;
}
...
switch((contatore%2)+1) {
    ...
    {vittoria=1;
      ...
      {vittoria=1;
        ...
        if (vittoria==0&&contatore%2==1)
        {

          trovac();
          if(a[cellalibera] == 0){      contatore++;}
            if (contatore%2 == 0 && a[cellalibera] == 0) {
                a[cellalibera] = 1;
            }
            else if (cellalibera%2 ==1  && a[cellalibera] == 0)
            {
                a[cellalibera] = 2;
            }
            if(a[cellalibera] ==1)
            document.getElementById(cellalibera).innerHTML =x;

            else if (a[casella] == 2)
                document.getElementById(cellalibera).innerHTML =cerchio;
